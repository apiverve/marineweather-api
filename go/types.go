// Package marineweather provides a Go client for the Marine Weather API.
//
// For more information, visit: https://apiverve.com/marketplace/marineweather?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Marine Weather API.
//
// Parameters:
//   - lat (required): number - The latitude coordinate of the location [min: -90, max: 90]
//   - lon (required): number - The longitude coordinate of the location [min: -180, max: 180]
type Request struct {
...
// ResponseData contains the data returned by the Marine Weather API.
...
// WeatherData represents the weather object.
type WeatherData struct {
	...
	Maxwindmph int `json:"maxwindmph"`
	Maxwindkph float64 `json:"maxwindkph"`
	Totalprecipmm float64 `json:"totalprecipmm"`
	Totalprecipin float64 `json:"totalprecipin"`
	Totalsnowcm int `json:"totalsnowcm"`
	Avgviskm float64 `json:"avgviskm"`
	Avgvismiles int `json:"avgvismiles"`
	Moonphase string `json:"moonphase"`
	Moonillumination int `json:"moonillumination"`
}
