...
const (
	baseURL        = "https://api.apiverve.com/v1/marineweather"
	defaultTimeout = 30 * time.Second
)

// Client is the Marine Weather API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Marine Weather API client.
...
// Execute makes a request to the Marine Weather API with typed parameters.
//
