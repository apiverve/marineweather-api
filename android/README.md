...
```gradle
dependencies {
    implementation 'com.github.apiverve:marineweather-api:1.1.13'
}
```
...
```java
import com.apiverve.marineweather.MarineWeatherAPIClient;
import com.apiverve.marineweather.APIResponse;
import com.apiverve.marineweather.APIException;

// Initialize the client
MarineWeatherAPIClient client = new MarineWeatherAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("lat", 29.48003);
    parameters.put("lon", -37.62424);
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/marineweather](https://docs.apiverve.com/ref/marineweather)
...
- **Documentation:** [https://docs.apiverve.com/ref/marineweather](https://docs.apiverve.com/ref/marineweather)
- **Issues:** [GitHub Issues](https://github.com/apiverve/marineweather-api/issues)
