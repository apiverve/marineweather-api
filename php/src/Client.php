...
namespace APIVerve\Marineweather;
...
/**
 * Client for the Marine Weather API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/marineweather?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/marineweather';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\MarineweatherClient] {$message}\n";
        }
    }
}
