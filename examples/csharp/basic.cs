/*
 * Marine Weather API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Marine Weather API.
 * API Documentation: https://docs.apiverve.com/ref/marineweather
 */
...
{
    class MarineWeatherExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/marineweather";

        /// <summary>
        /// Make a GET request to the Marine Weather API
        /// </summary>
        static async Task<JsonDocument> CallMarineWeatherAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;lat&quot;] &#x3D; 29.48003, [&quot;lon&quot;] &#x3D; -37.62424 };
        ...
        {
            Console.WriteLine("📤 Calling Marine Weather API...\n");

            var result = await CallMarineWeatherAPI();
